...
static const unsigned long sqlctx = 1035563113;
...
d fecha_documento<=to_date(:b2,'yyyymmdd')) and contado is null ) and estado_f\
actura=0) order by numero_factura            ";
...
28,0,0,2,355,0,9,137,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
