...
static unsigned long sqlctx = 261827;
...
36,0,0,2,94,0,4,175,0,0,3,1,0,1,0,2,4,0,0,2,4,0,0,1,9,0,0,
63,0,0,6,82,0,5,247,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
86,0,0,7,0,0,32,258,0,0,0,0,0,1,0,
101,0,0,8,260,0,4,273,0,0,5,4,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
136,0,0,3,422,0,9,287,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
167,0,0,3,0,0,13,289,0,0,10,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
222,0,0,3,0,0,13,347,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,
0,0,2,4,0,0,2,4,0,0,
269,0,0,3,0,0,15,375,0,0,0,0,0,1,0,
284,0,0,5,261,0,9,387,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
307,0,0,5,0,0,15,392,0,0,0,0,0,1,0,
322,0,0,9,170,0,4,437,0,0,2,1,0,1,0,2,9,0,0,1,4,0,0,
345,0,0,5,0,0,13,494,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,
392,0,0,10,65,0,4,552,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
415,0,0,4,451,0,9,565,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
446,0,0,4,0,0,13,568,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,
0,0,2,4,0,0,
489,0,0,4,0,0,15,604,0,0,0,0,0,1,0,
504,0,0,11,239,0,4,615,0,0,9,3,0,1,0,2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,4,0,0,2,
...
double  nit;
/* VARCHAR nitb[18]; */ 
struct { unsigned short len; unsigned char arr[18]; } nitb;

double  codigo_nit;
double  codigo_nit2;
/* VARCHAR codigo_bco[10]; */ 
struct { unsigned short len; unsigned char arr[10]; } codigo_bco;
...
/* VARCHAR cuenta1[50]; */ 
struct { unsigned short len; unsigned char arr[50]; } cuenta1;
...
l_egr where codigo_emp=to_number(:b2)";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "update control_egr  set ult_listado=to_number(:b0) where \
...
(((((((d.codigo_emp=c.codigo_emp and d.ano_mes=c.ano_mes) and d.consecutivo=c.\
consecutivo) and d.libro=to_number(:b1)) and c.codigo_emp=:b2) and c.clase='EG\
') and c.comprobante=:b3) and c.ano_mes>=:b4)";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&numero_egreso;
...
_nit=n.codigo_nit) and p.codigo_emp<>3)";
        ...
        sqlstm.sqadto[0] = (unsigned short )0;
        sqlstm.sqtdso[0] = (unsigned short )0;
        sqlstm.sqhstv[1] = (         void  *)&codigo_nit2;
        sqlstm.sqhstl[1] = (unsigned int  )8;
        sqlstm.sqhsts[1] = (         int  )0;
        sqlstm.sqindv[1] = (         void  *)0;
        sqlstm.sqinds[1] = (         int  )0;
