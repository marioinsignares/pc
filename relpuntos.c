...
static const unsigned long sqlctx = 1178633049;
...
e) ,to_char(o.fecha_control,'DD-MON-YYYY') ,o.consecutivo ,o.ano_mes ,nvl(punt\
os,0)  from nits n ,ordenes_c o ,ciudades c ,clientes ct where ((((((n.codigo_\
nit=ct.codigo_nit and ct.codigo_cliente=o.codigo_cliente) and n.codigo_ciu=c.c\
odigo) and to_char(o.fecha_documento,'yyyymmdd')>=:b0) and to_char(o.fecha_doc\
umento,'yyyymmdd')<=:b1) and o.codigo_cliente>=:b2) and o.codigo_cliente<=:b3)\
...
28,0,0,2,140,0,4,189,0,4,1,0,1,0,2,9,0,0,2,4,0,0,2,3,0,0,1,9,0,0,
58,0,0,3,519,0,9,215,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
88,0,0,3,0,0,13,219,0,8,0,0,1,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,
0,2,3,0,0,2,3,0,0,
134,0,0,5,140,0,4,244,0,5,1,0,1,0,2,9,0,0,2,4,0,0,2,9,0,0,2,4,0,0,1,4,0,0,
168,0,0,4,93,0,9,257,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
190,0,0,4,0,0,13,261,0,1,0,0,1,0,2,3,0,0,
208,0,0,4,0,0,15,282,0,0,0,0,1,0,
};
