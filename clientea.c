...
static const unsigned long sqlctx = 1202508365;
...
,paretto p where ((((n.codigo_nit=cl.codigo_nit and n.codigo_ciu=c.codigo) and\
 cl.codigo_cliente>=:b0) and cl.codigo_cliente<=:b1) and cl.codigo_cliente=p.c\
odigo_cliente) group by cl.codigo_cliente,n.nombre,n.nombre_muni,c.nombre,n.di\
reccion,n.nit,digito,n.codigo_nit order by cl.codigo_cliente            ";
...
28,0,0,2,460,0,9,162,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
50,0,0,2,0,0,13,167,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,3,0,
0,2,4,0,0,
92,0,0,5,54,0,4,192,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
114,0,0,2,0,0,15,230,0,0,0,0,1,0,
128,0,0,3,0,0,15,231,0,0,0,0,1,0,
142,0,0,4,0,0,15,232,0,0,0,0,1,0,
156,0,0,6,0,0,30,234,0,0,0,0,1,0,
170,0,0,3,84,0,9,244,0,1,1,0,1,0,1,9,0,0,
188,0,0,3,0,0,13,247,0,1,0,0,1,0,2,4,0,0,
206,0,0,3,0,0,15,266,0,0,0,0,1,0,
220,0,0,4,69,0,9,274,0,1,1,0,1,0,1,9,0,0,
238,0,0,4,0,0,13,277,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
260,0,0,4,0,0,15,301,0,0,0,0,1,0,
};
 ...
 **********************************************/
    ...
    /* EXEC SQL DECLARE C1 CURSOR FOR
	     ...
	     from nits n, ciudades c, clientes cl, paretto p
             where n.codigo_nit       = cl.codigo_nit                     and
                   n.codigo_ciu       = c.codigo                          and
                   cl.codigo_cliente >= :codigo_clii                      and
                   cl.codigo_cliente <= :codigo_clif                      and
...
void titulos()
{
 ...
 fprintf (fp,"%s\n\n",nombre_ciu.arr);
 fprintf (fp,"%s\n","CODIG");
 fprintf (fp,"%s%s %-45s %-45s %-20s %-25s %-17s %-45s\n\n",condensado_on,"CLIEN","NOMBRE","DIRECCION","CIUDAD","TELEFONO(S)","NIT","CONTACTO");
 con_lin=10;
}
