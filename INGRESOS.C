...
static unsigned long sqlctx = 529603;
...
86,0,0,6,276,0,4,195,0,0,10,2,0,1,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,
9,0,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,
141,0,0,7,185,0,4,235,0,0,3,1,0,1,0,2,9,0,0,2,9,0,0,1,9,0,0,
168,0,0,2,247,0,9,247,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
199,0,0,3,339,0,9,250,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
226,0,0,2,0,0,15,272,0,0,0,0,0,1,0,
241,0,0,3,0,0,15,273,0,0,0,0,0,1,0,
256,0,0,8,82,0,5,278,0,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
279,0,0,2,0,0,15,288,0,0,0,0,0,1,0,
294,0,0,3,0,0,15,289,0,0,0,0,0,1,0,
309,0,0,9,0,0,30,291,0,0,0,0,0,1,0,
324,0,0,2,0,0,13,326,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,4,
0,0,2,4,0,0,
367,0,0,3,0,0,13,395,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,
};
...

{
         ...
         sqlstm.sqladtp = &sqladt;
         sqlstm.sqltdsp = &sqltds;
         sqlstm.stmt = "select fecha ,nvl(codigo_cliente,' ') ,nvl(nit,0) ,n\
vl(codigo_nit,0) ,nvl(valor_efectivos,0) ,nvl(comentarios,' ') ,ano_mes ,conse\
cutivo into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7  from ingresos_c where (((codigo_e\
mp=:b8 and tipo_documento='RC') and ano_mes>=200601) and numero=:b9)";
         sqlstm.iters = (unsigned int  )1;
