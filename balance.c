...
static unsigned long sqlctx = 257267;
...
"select p.cuenta ,p.nombre ,sum(decode(db_cr,'DB',(a.valor_deb-a.valor_cre),(\
a.valor_cre-a.valor_deb))) ,p.db_cr  from plan p ,acumulados a where (((((((p.\
nivel='2' and p.cuenta=substr(a.cuenta,1,4)) and a.codigo_emp=p.codigo_emp) an\
d a.codigo_emp=:b0) and p.cuenta>=:b1) and p.cuenta<=:b2) and a.ano_mes>=:b3) \
and a.ano_mes<=:b4) group by p.cuenta,p.nombre,p.db_cr           ";
...
36,0,0,2,140,0,4,133,0,0,4,1,0,1,0,2,9,0,0,2,4,0,0,2,3,0,0,1,9,0,0,
67,0,0,3,375,0,9,163,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
102,0,0,3,0,0,15,172,0,0,0,0,0,1,0,
117,0,0,3,375,0,9,177,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
152,0,0,3,0,0,15,180,0,0,0,0,0,1,0,
167,0,0,3,375,0,9,185,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
202,0,0,3,0,0,15,188,0,0,0,0,0,1,0,
217,0,0,3,375,0,9,193,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
252,0,0,3,0,0,15,197,0,0,0,0,0,1,0,
267,0,0,3,375,0,9,202,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
302,0,0,3,0,0,15,207,0,0,0,0,0,1,0,
317,0,0,3,375,0,9,212,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
352,0,0,3,0,0,15,221,0,0,0,0,0,1,0,
367,0,0,4,0,0,30,223,0,0,0,0,0,1,0,
382,0,0,3,0,0,13,257,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,
};
...
/* VARCHAR cuentai    [15]; */ 
struct { unsigned short len; unsigned char arr[15]; } cuentai;

/* VARCHAR cuentaf    [15]; */ 
struct { unsigned short len; unsigned char arr[15]; } cuentaf;
