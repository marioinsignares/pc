...
static unsigned long sqlctx = 32531;
...
"select e.tipo ,e.cuenta_db ,e.cuenta_cr ,round((((abs(sum((nvl(valor_cre,0)-\
nvl(valor_deb,0))))* e.operacion)* c.tarifa)/100),0) valor_sinop ,to_char(last\
_day(to_date(:b0,'yyyymm')),'DD-MON-YYYY') fecha ,a.sucursal ,1 cen_cos ,c.tar\
ifa ,e.codigo_nit ,e.nit  from acumulados a ,cree e ,actividadeco c where ((((\
(a.codigo_emp=:b1 and a.libro=:b2) and a.ano_mes=:b0) and a.codigo_emp=e.codig\
o_emp) and substr(a.cuenta,1,length(e.cuenta))=e.cuenta) and e.codigo_ac=c.cod\
igo_ac) group by e.tipo,e.cuenta_db,e.cuenta_cr,e.operacion,c.tarifa,a.sucursa\
l,cen_cos,e.codigo_nit,e.nit order by a.sucursal,1,6,4            ";
...
36,0,0,2,35,0,9,225,0,0,0,0,0,1,0,
51,0,0,2,0,0,13,233,0,0,1,0,0,1,0,2,9,0,0,
70,0,0,2,0,0,15,249,0,0,0,0,0,1,0,
85,0,0,3,610,0,9,321,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
116,0,0,2,0,0,15,334,0,0,0,0,0,1,0,
131,0,0,3,0,0,15,335,0,0,0,0,0,1,0,
146,0,0,5,0,0,30,337,0,0,0,0,0,1,0,
161,0,0,6,134,0,4,350,0,0,4,3,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
192,0,0,7,142,0,2,365,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
223,0,0,8,133,0,4,376,0,0,4,3,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
254,0,0,9,148,0,2,384,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
281,0,0,10,165,0,4,402,0,0,4,3,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
312,0,0,11,114,0,3,418,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
343,0,0,12,117,0,5,429,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
374,0,0,13,161,0,4,441,0,0,4,3,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
405,0,0,14,115,0,3,452,0,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
432,0,0,15,117,0,5,459,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
463,0,0,3,0,0,13,465,0,0,10,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,4,0,0,2,3,0,0,2,4,0,0,
518,0,0,16,203,0,3,511,0,0,6,6,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
9,0,0,
557,0,0,3,0,0,13,562,0,0,10,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,4,0,0,2,3,0,0,2,4,0,0,
612,0,0,17,243,0,3,679,0,0,15,15,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,
687,0,0,18,243,0,3,712,0,0,15,15,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,
762,0,0,19,125,0,4,740,0,0,7,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,
9,0,0,1,9,0,0,
};
...

{
      ...
      sqlstm.sqltdsp = &sqltds;
      sqlstm.stmt = "insert into control_mes(FUENTE,ANO_MES,NOMBRE,CONSECUTI\
VO,CODIGO_EMP) values ('22',:b0,'CONTROL IMPUESTOS',:b1,:b2)";
      sqlstm.iters = (unsigned int  )1;
      ...
      sqlstm.sqadto[0] = (unsigned short )0;
      sqlstm.sqtdso[0] = (unsigned short )0;
      sqlstm.sqhstv[1] = (         void  *)&consecutivob;
      sqlstm.sqhstl[1] = (unsigned int  )9;
      sqlstm.sqhsts[1] = (         int  )0;
      sqlstm.sqindv[1] = (         void  *)0;
      sqlstm.sqinds[1] = (         int  )0;
