...
static const unsigned long sqlctx = 1214601165;
...
"select cantidad ,(cantidad* valor_venta) ,decode(substr(codigo_articulo,1,1)\
,'4',1,'5',1,'B',1,0) ,decode(substr(codigo_articulo,3,2),'50',1,'51',1,'52',1\
,'54',1,'55',1,'56',1,'57',1,0)  from ordenes_d d where (d.consecutivo=:b0 and\
 d.ano_mes=:b1)           ";
...
{8,4114,
2,0,0,1,0,0,27,126,0,3,3,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,
28,0,0,2,392,0,9,163,0,1,1,0,1,0,1,9,0,0,
46,0,0,3,415,0,9,177,0,1,1,0,1,0,1,9,0,0,
64,0,0,2,0,0,13,183,0,8,0,0,1,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,
0,2,3,0,0,2,3,0,0,
110,0,0,3,0,0,13,187,0,8,0,0,1,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,
0,2,3,0,0,2,3,0,0,
156,0,0,5,140,0,4,213,0,5,1,0,1,0,2,9,0,0,2,4,0,0,2,9,0,0,2,4,0,0,1,4,0,0,
190,0,0,4,258,0,9,226,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
212,0,0,4,0,0,13,231,0,4,0,0,1,0,2,3,0,0,2,4,0,0,2,9,0,0,2,9,0,0,
242,0,0,4,0,0,15,251,0,0,0,0,1,0,
256,0,0,6,0,0,30,257,0,0,0,0,1,0,
};
...
/* VARCHAR clase          [20]; */ 
struct { unsigned short len; unsigned char arr[20]; } clase;

/* VARCHAR tipo           [20]; */ 
struct { unsigned short len; unsigned char arr[20]; } tipo;
...

{
                ...
                sqlstm.sqlest = (unsigned char  *)&sqlca;
                sqlstm.sqlety = (unsigned short)0;
                sqlstm.sqhstv[0] = (unsigned char  *)&cantidad;
