...
static const unsigned long sqlctx = 1216140660;
...
nd f.codigo_emp=:b0) and c.libroaux=1) group by e.codigo,n.nombre,c.concepto,c\
.nombre order by c.concepto,e.codigo            ";
...
28,0,0,2,436,0,9,134,0,1,1,0,1,0,1,9,0,0,
46,0,0,3,0,0,30,136,0,0,0,0,1,0,
60,0,0,2,0,0,15,137,0,0,0,0,1,0,
74,0,0,2,0,0,13,157,0,5,0,0,1,0,2,3,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,4,0,0,
108,0,0,2,0,0,13,180,0,5,0,0,1,0,2,3,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,4,0,0,
142,0,0,4,182,0,4,217,0,4,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,
};
...
if (argc < 5)
   {
    ...
    printf ("Uso : nomlides codigo_emp device copias userid/password\n");
