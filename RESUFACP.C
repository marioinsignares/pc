...
static const unsigned long sqlctx = 1200091088;
...
"select codigo_cliente ,sum(cant_ordenes_o) ,sum(cant_ordenes_c) ,sum(cant_de\
spachos) ,sum(valor_oftalmica) ,sum(valor_contacto) ,sum(valor_fletes) ,sum(va\
lor_iva) ,sum(rete_fte) ,sum(valor_neto)  from facturas f where ((((((to_numbe\
r(:b0)=tipo_factura and tipo_documento='F') and fecha_documento>=to_date(to_nu\
mber(:b1),'yyyymmdd')) and fecha_documento<=to_date(to_number(:b2),'yyyymmdd')\
) and codigo_cliente>=:b3) and codigo_cliente<=:b4) and  not exists (select 'x\
'  from basura where ((f.tipo_factura=tipo_factura and f.tipo_documento=tipo_d\
ocumento) and f.numero_factura=numero_factura))) group by codigo_cliente order\
 by codigo_cliente            ";
...
r(:b0)=tipo_factura and tipo_documento='F') and fecha_documento>=to_date(to_nu\
mber(:b1),'yyyymmdd')) and fecha_documento<=to_date(to_number(:b2),'yyyymmdd')\
) and codigo_cliente>=:b3) and codigo_cliente<=:b4) and exists (select 'x'  fr\
om basura where ((f.tipo_factura=tipo_factura and f.tipo_documento=tipo_docume\
nto) and f.numero_factura=numero_factura))) group by codigo_cliente order by c\
odigo_cliente            ";
...
{8,4114,
2,0,0,1,0,0,27,157,0,3,3,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,
28,0,0,4,0,0,30,241,0,0,0,0,1,0,
42,0,0,2,652,0,9,262,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
76,0,0,2,0,0,13,265,0,10,0,0,1,0,2,9,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,4,0,0,2,4,0,
0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
130,0,0,2,0,0,15,306,0,0,0,0,1,0,
144,0,0,3,647,0,9,315,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
178,0,0,3,0,0,13,321,0,10,0,0,1,0,2,9,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,4,0,0,2,4,
0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
232,0,0,3,0,0,15,362,0,0,0,0,1,0,
246,0,0,5,111,0,4,370,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
268,0,0,6,54,0,4,445,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
290,0,0,7,544,0,4,548,0,6,1,0,1,0,2,3,0,0,2,3,0,0,2,4,0,0,2,9,0,0,2,9,0,0,1,9,
0,0,
328,0,0,8,120,0,4,567,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
};
...

{
       ...
       sqlstm.sqindv[0] = (         short *)0;
       sqlstm.sqharm[0] = (unsigned long )0;
       sqlstm.sqhstv[1] = (unsigned char  *)&cant_ordenes_o;
       sqlstm.sqhstl[1] = (unsigned long  )4;
       sqlstm.sqindv[1] = (         short *)0;
       sqlstm.sqharm[1] = (unsigned long )0;
       sqlstm.sqhstv[2] = (unsigned char  *)&cant_ordenes_c;
       sqlstm.sqhstl[2] = (unsigned long  )4;
       sqlstm.sqindv[2] = (         short *)0;
       sqlstm.sqharm[2] = (unsigned long )0;
       sqlstm.sqhstv[3] = (unsigned char  *)&cant_despachos;
       sqlstm.sqhstl[3] = (unsigned long  )4;
       sqlstm.sqindv[3] = (         short *)0;
       sqlstm.sqharm[3] = (unsigned long )0;
       sqlstm.sqhstv[4] = (unsigned char  *)&valor_oftalmica;
       sqlstm.sqhstl[4] = (unsigned long  )8;
       sqlstm.sqindv[4] = (         short *)0;
       sqlstm.sqharm[4] = (unsigned long )0;
       sqlstm.sqhstv[5] = (unsigned char  *)&valor_contacto;
       sqlstm.sqhstl[5] = (unsigned long  )8;
       sqlstm.sqindv[5] = (         short *)0;
       sqlstm.sqharm[5] = (unsigned long )0;
       sqlstm.sqhstv[6] = (unsigned char  *)&valor_fletes;
       sqlstm.sqhstl[6] = (unsigned long  )8;
       sqlstm.sqindv[6] = (         short *)0;
       sqlstm.sqharm[6] = (unsigned long )0;
       sqlstm.sqhstv[7] = (unsigned char  *)&valor_iva;
       sqlstm.sqhstl[7] = (unsigned long  )8;
       sqlstm.sqindv[7] = (         short *)0;
       sqlstm.sqharm[7] = (unsigned long )0;
       sqlstm.sqhstv[8] = (unsigned char  *)&valor_rete_fte;
