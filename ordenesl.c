...
static const unsigned long sqlctx = 1279732019;
...
ro ,cl.nombre ,d.clase_mat_fac ,d.tipo_mat_fac ,costo_promedio_p ,nvl(puntos,0\
) ,decode(substr(codigo_articulo,1,1),'4',1,'5',1,'B',1,0) ,decode(substr(codi\
go_articulo,3,2),'51',1,'54',1,'55',1,'57',1,0) ,substr(codigo_articulo,3,2) ,\
codigo_prv ,lote  from ordenes_d d ,clase cl where ((d.consecutivo=:b0 and d.a\
no_mes=:b1) and nvl(d.clase_mat_fac,clase_mat)=cl.clase_material(+)) order by \
lado_lente            ";
...
{8,4114,
2,0,0,1,0,0,27,244,0,3,3,0,1,0,1,9,0,0,1,10,0,0,1,10,0,0,
28,0,0,2,874,0,4,269,0,27,2,0,1,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
...
1,9,0,0,1,9,0,0,
150,0,0,3,57,0,4,316,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
172,0,0,6,146,0,4,351,0,6,1,0,1,0,2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,1,9,
0,0,
210,0,0,7,81,0,4,365,0,3,2,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,
236,0,0,8,81,0,4,373,0,3,2,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,
262,0,0,9,35,0,9,387,0,0,0,0,1,0,
276,0,0,9,0,0,13,394,0,1,0,0,1,0,2,9,0,0,
294,0,0,9,0,0,15,408,0,0,0,0,1,0,
308,0,0,4,644,0,9,425,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
330,0,0,4,0,0,13,429,0,26,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,3,
...
2,9,0,0,
448,0,0,4,0,0,15,583,0,0,0,0,1,0,
462,0,0,5,0,0,15,584,0,0,0,0,1,0,
476,0,0,10,0,0,32,587,0,0,0,0,1,0,
490,0,0,11,64,0,5,595,0,1,1,0,1,0,1,9,0,0,
508,0,0,12,104,0,4,687,0,4,3,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
538,0,0,13,83,0,4,708,0,3,2,0,1,0,2,9,0,0,1,9,0,0,1,9,0,0,
564,0,0,14,62,0,4,723,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
586,0,0,15,54,0,4,737,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
608,0,0,5,338,0,9,750,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
638,0,0,5,0,0,13,752,0,3,0,0,1,0,2,9,0,0,2,3,0,0,2,4,0,0,
664,0,0,5,0,0,15,795,0,0,0,0,1,0,
678,0,0,5,0,0,15,809,0,0,0,0,1,0,
692,0,0,5,0,0,15,824,0,0,0,0,1,0,
706,0,0,5,0,0,15,835,0,0,0,0,1,0,
720,0,0,5,0,0,15,847,0,0,0,0,1,0,
734,0,0,5,0,0,15,857,0,0,0,0,1,0,
748,0,0,5,0,0,13,988,0,3,0,0,1,0,2,9,0,0,2,3,0,0,2,4,0,0,
774,0,0,16,134,0,4,1049,0,4,3,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
804,0,0,17,345,0,4,1059,0,5,3,0,1,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
838,0,0,18,151,0,4,1085,0,5,3,0,1,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
872,0,0,19,130,0,3,1099,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
902,0,0,20,135,0,5,1108,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,4,0,0,
936,0,0,21,147,0,4,1122,0,5,3,0,1,0,2,4,0,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
970,0,0,22,130,0,3,1133,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1000,0,0,23,135,0,5,1140,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,4,0,0,
1034,0,0,24,218,0,3,1152,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1068,0,0,25,203,0,3,1209,0,12,12,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1130,0,0,26,203,0,3,1254,0,12,12,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1192,0,0,27,303,0,4,1274,0,4,3,0,1,0,2,4,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1222,0,0,28,451,0,9,1304,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
1248,0,0,28,0,0,13,1306,0,8,0,0,1,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,2,4,0,0,
1294,0,0,29,203,0,3,1357,0,12,12,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1356,0,0,28,0,0,13,1367,0,8,0,0,1,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,4,0,0,2,4,0,0,
1402,0,0,30,99,0,4,1394,0,6,2,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,1,9,0,0,1,
9,0,0,
};
...

{
    ...
    /* EXEC SQL DECLARE C2 CURSOR FOR
             select lado_lente, nvl(d.tipo_mat_fac,d.tipo_material), d.colorv,
                    ...
                    decode(substr(codigo_articulo,3,2),'51',1,'54',1,'55',1,'57',1,0),
...

{
    ...
    while (staora == 0) {
          ...
          /* EXEC SQL FETCH C2 INTO :lado_lente, :d_tipo_material, :colorv,
                                 ...
                                 :costo_promedio_p, :puntos, :clase_prom, :promocion, :premios, :codigo_prv, :lote; */ 
...
(:b0)";
  sqlstm.iters = (unsigned long  )1;
  sqlstm.offset = (unsigned short)490;
  sqlstm.cud = sqlcud0;
  sqlstm.sqlest = (unsigned char  *)&sqlca;
  sqlstm.sqlety = (unsigned short)0;
...
b1";
 sqlstm.iters = (unsigned long  )1;
 sqlstm.offset = (unsigned short)564;
 sqlstm.selerr = (unsigned short)1;
 sqlstm.cud = sqlcud0;
 sqlstm.sqlest = (unsigned char  *)&sqlca;
 sqlstm.sqlety = (unsigned short)0;
...

{
 ...
 sqlstm.iters = (unsigned long  )1;
 sqlstm.offset = (unsigned short)586;
 sqlstm.selerr = (unsigned short)1;
 sqlstm.cud = sqlcud0;
 sqlstm.sqlest = (unsigned char  *)&sqlca;
 sqlstm.sqlety = (unsigned short)0;
...

{
 ...
 sqlstm.stmt = sq0005;
 sqlstm.iters = (unsigned long  )1;
 sqlstm.offset = (unsigned short)608;
 sqlstm.cud = sqlcud0;
 sqlstm.sqlest = (unsigned char  *)&sqlca;
 sqlstm.sqlety = (unsigned short)0;
 sqlstm.sqhstv[0] = (unsigned char  *)&consecutivoa;
...

{
    ...
    sqlstm.arrsiz = 27;
    sqlstm.iters = (unsigned long  )1;
    sqlstm.offset = (unsigned short)664;
    sqlstm.cud = sqlcud0;
    sqlstm.sqlest = (unsigned char  *)&sqlca;
    sqlstm.sqlety = (unsigned short)0;
    sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
...

{
    ...
    sqlstm.arrsiz = 27;
    sqlstm.iters = (unsigned long  )1;
    sqlstm.offset = (unsigned short)678;
    sqlstm.cud = sqlcud0;
    sqlstm.sqlest = (unsigned char  *)&sqlca;
    sqlstm.sqlety = (unsigned short)0;
    sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
...

{
    ...
    sqlstm.arrsiz = 27;
    sqlstm.iters = (unsigned long  )1;
    sqlstm.offset = (unsigned short)692;
    sqlstm.cud = sqlcud0;
    sqlstm.sqlest = (unsigned char  *)&sqlca;
    sqlstm.sqlety = (unsigned short)0;
    sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
...
//              strcpy(mensaje,"Promover Transitions 2009 - Cupo\b'n blanco");  //Para el resto
              strcpy(mensaje," ");
           }
...
0)";
           sqlstm.iters = (unsigned long  )1;
           sqlstm.offset = (unsigned short)872;
           sqlstm.cud = sqlcud0;
           sqlstm.sqlest = (unsigned char  *)&sqlca;
           sqlstm.sqlety = (unsigned short)0;
...
','','')";
       sqlstm.iters = (unsigned long  )1;
       sqlstm.offset = (unsigned short)1034;
       sqlstm.cud = sqlcud0;
       sqlstm.sqlest = (unsigned char  *)&sqlca;
       sqlstm.sqlety = (unsigned short)0;
...
estado<>'2')";
    sqlstm.iters = (unsigned long  )1;
    sqlstm.offset = (unsigned short)1192;
    sqlstm.selerr = (unsigned short)1;
    sqlstm.cud = sqlcud0;
    sqlstm.sqlest = (unsigned char  *)&sqlca;
    sqlstm.sqlety = (unsigned short)0;
...

{
      ...
      sqlstm.stmt = sq0028;
      sqlstm.iters = (unsigned long  )1;
      sqlstm.offset = (unsigned short)1222;
      sqlstm.cud = sqlcud0;
      sqlstm.sqlest = (unsigned char  *)&sqlca;
      sqlstm.sqlety = (unsigned short)0;
      sqlstm.sqhstv[0] = (unsigned char  *)&codigo_emp;
...

{
      ...
      sqlstm.arrsiz = 27;
      sqlstm.iters = (unsigned long  )1;
      sqlstm.offset = (unsigned short)1248;
      sqlstm.cud = sqlcud0;
      sqlstm.sqlest = (unsigned char  *)&sqlca;
      sqlstm.sqlety = (unsigned short)0;
      sqlstm.sqhstv[0] = (unsigned char  *)&consecutivo;
...
AL,CEN_COS) values (:b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,'001',1)";
              sqlstm.iters = (unsigned long  )1;
              sqlstm.offset = (unsigned short)1294;
              sqlstm.cud = sqlcud0;
              sqlstm.sqlest = (unsigned char  *)&sqlca;
              sqlstm.sqlety = (unsigned short)0;
              sqlstm.sqhstv[0] = (unsigned char  *)&codigo_emp;
...

{
           ...
           sqlstm.arrsiz = 27;
           sqlstm.iters = (unsigned long  )1;
           sqlstm.offset = (unsigned short)1356;
           sqlstm.cud = sqlcud0;
           sqlstm.sqlest = (unsigned char  *)&sqlca;
           sqlstm.sqlety = (unsigned short)0;
           sqlstm.sqhstv[0] = (unsigned char  *)&consecutivo;
...
an where (codigo_emp=:b4 and cuenta=:b5)";
  sqlstm.iters = (unsigned long  )1;
  sqlstm.offset = (unsigned short)1402;
  sqlstm.selerr = (unsigned short)1;
  sqlstm.cud = sqlcud0;
  sqlstm.sqlest = (unsigned char  *)&sqlca;
  sqlstm.sqlety = (unsigned short)0;
