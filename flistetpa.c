...
static const unsigned long sqlctx = 1052314532;
...
m paretto p ,nits n ,ciudades c ,clientes cl where ((((n.codigo_nit=cl.codigo_\
nit and n.codigo_ciu=c.codigo) and cl.codigo_cliente=p.codigo_cliente) and p.c\
odigo_cliente>=:b0) and p.codigo_cliente<=:b1) group by n.nombre,n.nombre_muni\
,c.nombre,n.direccion,n.codigo_nit,p.valor order by p.valor desc             ";
...
28,0,0,2,387,0,9,150,0,2,2,0,1,0,1,9,0,0,1,9,0,0,
50,0,0,2,0,0,15,198,0,0,0,0,1,0,
64,0,0,4,0,0,30,199,0,0,0,0,1,0,
78,0,0,2,0,0,13,205,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,
108,0,0,5,54,0,4,229,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
130,0,0,3,84,0,9,247,0,1,1,0,1,0,1,9,0,0,
148,0,0,3,0,0,13,250,0,1,0,0,1,0,2,4,0,0,
166,0,0,3,0,0,15,269,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[8]; } codigo_cliei;

/* VARCHAR codigo_clief[8]; */ 
struct { unsigned short len; unsigned char arr[8]; } codigo_clief;
...

{
    ...
    sqlstm.sqlest = (unsigned char  *)&sqlca;
    sqlstm.sqlety = (unsigned short)0;
    sqlstm.sqhstv[0] = (unsigned char  *)&codigo_cliei;
    sqlstm.sqhstl[0] = (unsigned long  )10;
    sqlstm.sqindv[0] = (         short *)0;
    sqlstm.sqharm[0] = (unsigned long )0;
    sqlstm.sqhstv[1] = (unsigned char  *)&codigo_clief;
