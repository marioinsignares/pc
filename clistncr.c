...
static const unsigned long sqlctx = 1035563124;
...
nd contado is null ) order by numero            ";
...
28,0,0,2,358,0,9,142,0,3,3,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,
...
void titulos()
{
 ...
 fprintf(fp,"%s%s%s%43s",diezcpi,condensado_on,ancho_on,"LISTADO DE NOTAS CREDITO");
